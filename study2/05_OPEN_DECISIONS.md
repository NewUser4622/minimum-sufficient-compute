# Open decisions — needed before P0 starts

Five. Nothing is built until they are settled, because each one changes what
gets written.
...
**Needed: yes / no / a different framing.**
...
**Needed: confirm, or set a different number now — before P1, not after.**
...
**Needed: keep / cut / merge.**

---

## What I would do, if you want a single recommendation

**D1** yes · **D2** A · **D3** appendix · **D4** keep +1.0 and always report the
noise floor · **D5** keep as-is.

Then: verify the inventory, run P0's collinearity check, and stop there for a
decision. That is under an hour of compute and it tells us whether the study is
coherent before anything else is written.
